  ...
  return (
    <div className="Apps Body">
      ...
      <div className={styles.card_list}>
        ...
        <Card external={true} imagePath='random-quote-machine.png' title='Random Quote Machine' description='A simple app for generating a random quote and being able to share it written in ReactJS.' href='https://codepen.io/ghlennedgis/full/vYdoQag' />
      </div>
    </div>
  );
}
